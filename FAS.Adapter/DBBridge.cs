    ...
    public class DBBridge
    {
        ...
        public static string DBConnection()
        {
            try
            {
                ...
                //return BSEK.Properties.Settings.Default.BSEKConnectionString;
                //return System.Configuration.ConfigurationManager.AppSettings["BSEKConnectionString"];
                return System.Configuration.ConfigurationManager.ConnectionStrings["MatrixFASServices"].ConnectionString;
            }
            catch (Exception ce)
            {
